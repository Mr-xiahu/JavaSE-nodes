...
public class InvocationHandlerDemo {
	public static void main(String[] args) {
		...
		StudentDao dao = (StudentDao) Proxy.newProxyInstance(sd.getClass()
		...
		TeacherDao teacher = (TeacherDao) Proxy.newProxyInstance(td.getClass()
				.getClassLoader(), td.getClass().getInterfaces(), handler2);
		teacher.Login();
		teacher.Regix();
		System.out.println("---------------");
	}
